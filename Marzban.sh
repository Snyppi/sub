...
while [ -z "$LOCATION_STRING" ]; do
    ...
    echo "1) US 🇺🇸"; echo "2) GE 🇩🇪"; echo "3) NL 🇳🇱"; echo "4) FIN 🇫🇮"; echo "5) RU 🇷🇺"; echo "6) SWE 🇸🇪"
    ...
    case $choice in
        ...
        5) LOCATION_STRING="SnyppiVPN🇷🇺"; break ;; 6) LOCATION_STRING="SnyppiVPN🇸🇪"; break ;; *) echo -e "${RED}Неверный выбор.${NC}" ;;
    esac
done
